...
module.exports = (sequelize) => {
  const attributes = {
    ...
    roomType: { type: DataTypes.ENUM('stockroom', 'subStockroom', 'office', 'classroom', 'comfortroom', 'openarea', 'unknownroom'), allowNull: false, defaultValue: 'unknownroom' },
    stockroomType: { type: DataTypes.ENUM('apparel', 'supply', 'it', 'maintenance', 'unknownType' ), allowNull: true },
